...
class ItemFactory{
	...
	public static function init(){
		...
		$records = [
			Item::RECORD_13 => "record.13",
			Item::RECORD_CAT => "record.cat",
			Item::RECORD_BLOCKS => "record.blocks",
			Item::RECORD_CHIRP => "record.chirp",
			Item::RECORD_FAR => "record.far",
			Item::RECORD_MALL => "record.mall",
			Item::RECORD_MELLOHI => "record.mellohi",
			Item::RECORD_STAL => "record.stal",
			Item::RECORD_STRAD => "record.strad",
			Item::RECORD_WARD => "record.ward",
			Item::RECORD_11 => "record.11",
			Item::RECORD_WAIT => "record.wait",
			Item::RECORD_OTHERSIDE => "record.otherside",
			Item::RECORD_5 => "record.5",
			Item::RECORD_PIGSTEP => "record.pigstep",
			Item::RECORD_RELIC => "record.relic",
			Item::RECORD_CREATOR => "record.creator",
			Item::RECORD_CREATOR_MUSIC_BOX => "record.creator_music_box",
			Item::RECORD_PRECIPICE => "record.precipice",
			Item::RECORD_TEARS => "record.tears",
			Item::RECORD_LAVA_CHICKEN => "record.lava_chicken",
			Item::RECORD_BOUNCE => "record.bounce"
		];
