...
class StateData{
	...
	public const BREWING_STAND_SL_A_BIT = "brewing_stand_slot_a_bit";
	public const BREWING_STAND_SL_B_BIT = "brewing_stand_slot_b_bit";
	public const BREWING_STAND_SL_C_BIT = "brewing_stand_slot_c_bit";
	...
	public const MINECRAFT_BLOCK_FACE = "minecraft:block_face";
	public const MINECRAFT_CARDINAL_DIRECTION = "minecraft:cardinal_direction";
	public const MINECRAFT_CONNECTION_EAST = "minecraft:connection_east";
	public const MINECRAFT_CONNECTION_NORTH = "minecraft:connection_north";
	public const MINECRAFT_CONNECTION_SOUTH = "minecraft:connection_south";
	public const MINECRAFT_CONNECTION_WEST = "minecraft:connection_west";
	public const MINECRAFT_CORNER = "minecraft:corner";
	public const MINECRAFT_FACING_DIRECTION = "minecraft:facing_direction";
	public const MINECRAFT_MULTI_BLOCK_PART = "minecraft:multi_block_part";
	public const MINECRAFT_VERTICAL_HALF = "minecraft:vertical_half";
