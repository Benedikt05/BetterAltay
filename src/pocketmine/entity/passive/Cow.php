...
class Cow extends Animal{
	...
	protected function addBehaviors() : void{
		...
		$this->behaviorPool->setBehavior(3, new TemptBehavior($this, [ItemIds::WHEAT], 1.25));
	...
	public function getDrops() : array{
		return [
			ItemFactory::get(ItemIds::LEATHER, 0, rand(0, 2)),
			($this->isOnFire() ? ItemFactory::get(ItemIds::COOKED_BEEF, 0, rand(1, 3)) : ItemFactory::get(ItemIds::BEEF, 0, rand(1, 3)))
		];
	}
}