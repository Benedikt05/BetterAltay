...
class WitherSkullDangerous extends Projectile{

	public const NETWORK_ID = self::WITHER_SKULL_DANGEROUS;

	public $height = 0.4125;
	public $width = 0.4125;

	protected $damage = 20.0;
	protected $life = 0;

	public function getName() : string{
		return "WitherSkullDangerous";
	}
	...
	public function onUpdate(int $currentTick) : bool{
		if($this->isAlive() and !$this->closed and !$this->isFlaggedForDespawn()){
			$this->setOnFire(3);
			//$this->addEffect(new EffectInstance(Effect::getEffect(Effect::DECAY), 7 * 20, 1));
