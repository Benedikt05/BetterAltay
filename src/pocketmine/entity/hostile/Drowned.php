...
class Drowned extends Monster implements Ageable, Smite{
	...
	protected function initEntity() : void{
		...
		$this->equipment->setItemInHand(ItemFactory::get(Item::TRIDENT));
	}
	...
	public function getDrops() : array{
		...
		if(mt_rand(0, 199) < 5){
			switch(mt_rand(0, 2)){
				case 0:
					$drops[] = ItemFactory::get(Item::GOLD_INGOT, 0, 1);
					break;
				case 1:
