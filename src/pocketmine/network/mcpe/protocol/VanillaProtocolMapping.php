...
class VanillaProtocolMapping implements ProtocolInfo{
	...
	public static function getR12BlockMapProtocol(int $protocol) : int{
		if(in_array($protocol, [self::PROTOCOL_1_21_60, self::PROTOCOL_1_21_70, self::PROTOCOL_1_21_80, self::PROTOCOL_1_21_90, self::PROTOCOL_1_21_100, -2], true)){
			return self::PROTOCOL_1_21_100;
		}
